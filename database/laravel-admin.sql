...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `city`, `country_id`, `state_id`, `admin`, `verified`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, '8TTLr', 'admin@example.com', '$2y$10$DjH0Lnr29huhOGBIYU1jtur3zDkJIRb50P9SFDSts5tRj0NlALreG', 'gBAlhb', 6, 6, 1, 1, NULL, NULL, NULL),
(2, 'Rohit', 'rohit@spiderdev.in', '$2y$10$8ulIWlYqLRj30malN9.6MuTOLgNk1gJOhBKvGmH2rhluxmgvV8qQm', 'konta', 101, 3, 0, 0, 'k7PXXb0wjUuVVagB5KjM5r8cxvoyRg06HosjU6D7oqqS0FKunMACmJujo95z', '2018-06-06 22:01:56', '2018-06-06 22:01:56'),
(3, 'test user', 'test@gmal.co', '$2y$10$poMekt81gjqYktH/E4VoG.60HalXCO48Om20SQOTmU8/5aewDJj.6', 'pune', 3, 113, 0, 0, 'lePsG1u2BR46lVh7wuB4QuufVDQ16mghRjKfUOIZ1xWx0PMhpGdnueBfmOmr', '2018-06-06 22:08:48', '2018-06-06 22:08:48');
